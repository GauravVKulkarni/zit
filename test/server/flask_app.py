    ...
    if request.method == "POST":
        ...
        if registerLogin == "register":
            ...
            if os.path.exists(os.path.join(os.getcwd(), "uploads", username)):
                ...
                with open(
                    os.path.join(os.getcwd(), "uploads", username, "password.txt"), "w"
                ) as file:
                    file.write(password)
        else:
            ...
            with open(
                os.path.join(os.getcwd(), "uploads", username, "password.txt"), "r"
            ) as file:
...
def search():
    ...
    if not os.path.exists(
        os.path.join(os.getcwd(), "uploads", username, repo_name + ".db")
    ):
        return "False3"
    return send_file(
        os.path.join(os.getcwd(), "uploads", username, repo_name + ".db"),
